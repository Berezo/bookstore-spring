...
<%--    <div class="row mb-6">--%>
<%--        <div class="col-md-3 themed-grid-col">Okładka</div>--%>
<%--        <div class="col-md-2 themed-grid-col">Nazwa</div>--%>
<%--        <div class="col-md-2 themed-grid-col">Wydawnictwo</div>--%>
<%--        <div class="col-md-1 themed-grid-col">Cena</div>--%>
<%--        <div class="col-md-2 themed-grid-col">Kategoria</div>--%>
<%--        <div class="col-md-2 themed-grid-col">Przyciski</div>--%>
<%--    </div>--%>
<%--    <c:forEach var="book" items="${books}" >--%>
<%--        <c:url var="edit" value="/books/edit">--%>
<%--            <c:param name="bookId" value="${book.id}"/>--%>
...
<%--                <c:set var="cover" scope="session" value="${contextPath}${covers}${book.cover}"/>--%>
<%--                <img src="${cover}" alt="Tekst alternatywny" width="100%" height="auto" >--%>
<%--            </div>--%>
<%--            <div class="col-md-2 themed-grid-col">${book.name}</div>--%>
<%--            <div class="col-md-2 themed-grid-col">${book.publisher}</div>--%>
<%--            <div class="col-md-1 themed-grid-col">--%>
<%--                <fmt:formatNumber value = "${book.price}" type = "currency"/>--%>
<%--            </div>--%>
<%--            <div class="col-md-2 themed-grid-col">${book.category.name}</div>--%>
