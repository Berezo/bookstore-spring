...
<main class="flex-shrink-0">
    ...
    <div class="container">
        <div class="card text-white bg-primary">
            <div class="card-body">
                <h5 class="card-title">Witaj <sec:authentication property="name"/>!</h5>
                <h6 class="card-subtitle mb-2 text-muted"></h6>
                <p class="card-text">Jeśli chcesz zmienić swoje dane osobowe. Należy kliknąć w przycisk podany poniżej</p>
                <sec:authorize access="isAuthenticated()">
                    <c:url var="edit" value="/user/edit">
                        <c:param name="username" value="${pageContext.request.remoteUser}"/>
                    </c:url>
                    <a href="${edit}" class="btn btn-light">Przejdź</a>
                </sec:authorize>
                <sec:authorize access="!isAuthenticated()">
