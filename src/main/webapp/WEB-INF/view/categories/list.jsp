        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                ...
                <sec:authorize access="hasRole('ADMIN')">
                    <a class="nav-item nav-link active" href="${contextPath}/categories/add">Dodaj kategorię</a>
                </sec:authorize>
            </div>
        </div>
    </div>
...
<main class="justify-content-center">
    <ul class="list-group">
        <li class="list-group-item list-group-item-primary active" aria-current="true">Kategorie</li>
